...
class ActorsHQDataset(BaseDataset):
    ...
    def __init__(self, root_dirs: list[str], meta_path: str,
                 ...
                 num_train_frames: int = 1, # batch size
        ...
        for uid in tqdm(self.uids):
            ...
            # Load and cache whole camera parameters
            ...
            min_frame_int = int(min_frame) + 45  # actorshq min frame is 45
