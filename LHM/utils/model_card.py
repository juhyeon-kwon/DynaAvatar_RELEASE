...
MODEL_CONFIG_TRAIN={
    '1B': "./configs/train/human-lrm-1B-dynamic.yaml",
    '500M': "./configs/train/human-lrm-500M-dynamic.yaml",
    #'500M_dynamic': "./configs/train/human-lrm-500M-dynamic.yaml",
    'MINI': "./configs/train/human-lrm-mini-dynamic.yaml",
}
MODEL_CONFIG_EVAL={
    '1B': "./configs/eval/human-lrm-1B-dynamic.yaml",
    '500M': "./configs/eval/human-lrm-500M-dynamic.yaml",
    'MINI': "./configs/eval/human-lrm-mini-dynamic.yaml",
}
